...
export class ProductResolver {
	...
	public async createProduct(
		...
		console.log('Mutation createProduct called');
	...
	public async getProduct(@Args('input') input: string, @AuthMember('_id') memberId: ObjectId): Promise<Product> {
	...
	public async listProducts(
		...
		console.log('Query: listProducts');
		return await this.productService.listProducts(memberId, input);
	}
